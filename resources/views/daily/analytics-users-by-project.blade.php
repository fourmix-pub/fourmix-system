            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="btn-group" role="group" aria-label="...">
                        ...
                        <a type="button" class="btn btn-primary" href="{{ route('daily.analytics.users.byProject') }}">プロジェクト別担当者</a>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form class="form-horizontal" action="{{ route('daily.analytics.users.byProject') }}" class="form-horizontal" method="get">
                                ...
                                @component('components.elements.form.select', ['name' => 'project_id'])
                                    ...
                                    @foreach($projectsSelect as $projectSelect)
                                        <option value="{{ $projectSelect->id }}" @if((int)$projectId === (int)$projectSelect->id) selected @endif>{{ $projectSelect->name }}</option>
                                    @endforeach
                                @endcomponent
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                @component('components.elements.table.table')
                                    ...
                                    @endslot
                                    @slot('tbody')
                                        @foreach($project->sumByUser as $daily)
                                            <tr>
