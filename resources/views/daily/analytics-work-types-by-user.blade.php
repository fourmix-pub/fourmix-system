            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="btn-group" role="group" aria-label="...">
                        ...
                        <a type="button" class="btn btn-primary" href="{{ route('daily.analytics.workTypes.byUser') }}">担当者別作業分類</a>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form class="form-horizontal" action="{{ route('daily.analytics.workTypes.byUser') }}" class="form-horizontal" method="get">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                @component('components.elements.table.table')
                                    ...
                                    @endslot
                                    @slot('tbody')
                                        @foreach($user->sumByWorkType as $daily)
                                            <tr>
